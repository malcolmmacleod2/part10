     ...
     return (
        <View style={cardHeaderStyles.container}>
            ...
            <View style={cardHeaderStyles.infoContainer}>
                <Text style={cardHeaderStyles.heading}>{item.id}</Text>
                <Text style={cardHeaderStyles.subheading}>{item.description}</Text>
            </View>
        </View>
    );
};
    ...
    return (
        <View style={languageStyles.container}>
            <View style={languageStyles.infoContainer}>
                <Text style={languageStyles.language}>{item.language}</Text>
            </View>
        </View>
    );
};
    ...
    return (
        <View style={cardFooterStyles.container}>
            <View style={cardFooterStyles.section}>
                <Text style={cardFooterStyles.subheading}>{summaryValue(item.stargazersCount)}</Text>
                <Text style={cardFooterStyles.subheading}>Stars</Text>
            </View>
            <View style={cardFooterStyles.section}>
                <Text style={cardFooterStyles.subheading}>{summaryValue(item.forksCount)}</Text>
                <Text style={cardFooterStyles.subheading}>Forks</Text>
            </View>
            <View style={cardFooterStyles.section}>
                <Text style={cardFooterStyles.subheading}>{item.reviewCount}</Text>
                <Text style={cardFooterStyles.subheading}>Reviews</Text>
            </View>
            <View style={cardFooterStyles.section}>
                <Text style={cardFooterStyles.subheading}>{item.ratingAverage}</Text>
